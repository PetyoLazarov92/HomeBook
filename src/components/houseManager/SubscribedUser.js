        ...
        return(
            <div className="d-flex border align-items-center">
                <div>
                    ...
                    ?
                    <button onClick={() => this.props.approve(this.props.su.userId, this.props.coid)} className="d-flex btn box-shadow-none text-primary mx-2 p-0" title="Approve"><i className="material-icons md-36">person_add</i></button>
                    :
